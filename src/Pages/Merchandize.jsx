...
const Merchandize = () => {
    ...
    let filteredData = merchItems
      .filter(item => item.type === 'merchandize')
      .filter(item =>
    ...
    <div className="font-body pb-16">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white px-6">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">Shop Our Custom Merchandise</h1>
          <p className="text-lg md:text-xl mt-4 max-w-2xl">
            From aprons to mugs—bake in style with Bakerz merch!
          </p>
      ...
      {/* Title */}
      <h2 className="text-5xl font-bold my-10 text-center text-darkPurple">Merchandise</h2>
      ...
      {filteredData.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center mt-20 space-y-6">
          ...
          <p className="text-lg text-gray-600">
            No merchandise found for <span className="font-semibold">{activeCategory}</span>.
          </p>
        </div>
      )}
